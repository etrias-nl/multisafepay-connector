...
DEV_IMAGE_VERSION=$(shell curl -sS "https://hub.docker.com/v2/repositories/${DEV_IMAGE}/tags/?page_size=1&page=1&name=7.&ordering=last_updated" | jq -r '.results[0].name')
